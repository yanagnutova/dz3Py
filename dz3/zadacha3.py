...
if n == 1:
	print('За это слово вы получаете', sum([k for i in word for k, v in EN.items() if i in v]), 'очков')
elif n == 0:
	print('За это слово вы получаете', sum([k for i in word for k, v in RU.items() if i in v]), 'очков')
else:
